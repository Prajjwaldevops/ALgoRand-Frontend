                ...
                <button
                  ...
                  className={`w-full text-left p-3 rounded-xl transition-all text-sm ${
                    selectedBountyId === bounty.id
                      ? "border border-white/10 bg-zinc-900/50 backdrop-blur-sm border-[#ef233c]/30 bg-[#ef233c]/5"
            ...
            {selectedBounty ? (
              <div className="space-y-5">
                ...
                <div className="border border-white/10 bg-zinc-900/50 backdrop-blur-sm rounded-2xl p-6">
                  ...
                  <p className="text-xs text-zinc-400 leading-relaxed whitespace-pre-wrap mb-4">
                    {selectedBounty.description}
                  </p>
                  <div className="flex items-center gap-4 text-xs text-zinc-500 pt-3 border-t border-white/10">
                ...
                <div className="border border-white/10 bg-zinc-900/50 backdrop-blur-sm rounded-2xl p-6">
                  <h3 className="text-sm font-semibold mb-4 flex items-center gap-2">
                    <FileText className="w-4 h-4 text-[#ef233c]" /> Submissions (
                    {submissions.length})
                  </h3>
                        ...
                        >
                          ...
                          <div className="flex items-start justify-between mb-3">
                            <div className="flex items-center gap-3">
                              <div className="w-9 h-9 rounded-lg bg-[#ef233c]/10 flex items-center justify-center">
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-3">
                            ...
                            {sub.mega_nz_link && (
                              <a
                                ...
                                className="flex items-center gap-2 px-3 py-2.5 rounded-lg bg-vault-cyan/5 border border-[#ef233c]/20 hover:bg-[#ef233c]/10 transition-colors"
                              >
                                <ExternalLink className="w-4 h-4 text-[#ef233c]" />
                                <div className="flex-1 min-w-0">
                                  <p className="text-xs font-medium text-[#ef233c]">Mega.nz Link</p>
                                  <p className="text-[10px] text-zinc-500 truncate">{sub.mega_nz_link}</p>
                                </div>
                              </a>
                            )}
                            ...
                            {sub.encryption_key_url && (
                              <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center gap-2 px-3 py-2.5 rounded-lg bg-amber-500/5 border border-amber-500/20 hover:bg-amber-500/10 transition-colors"
                              >
                                <Lock className="w-4 h-4 text-amber-400" />
                                <div className="flex-1 min-w-0">
                                  <p className="text-xs font-medium text-amber-400">Encryption Key</p>
                                  <p className="text-[10px] text-zinc-500">Download .txt key file</p>
                                </div>
                          ...
                          {sub.work_hash_sha256 && (
                            <div className="glass p-2 rounded-lg mb-3">
                              <p className="text-[10px] text-zinc-500">Work Hash (SHA256)</p>
                              <p className="text-[10px] font-mono text-[#ef233c] break-all">
                                {sub.work_hash_sha256}
                              </p>
                            </div>
                          )}
                          ...
                          {sub.rejection_feedback && sub.status === "rejected" && (
                            <div className="glass p-3 rounded-lg mb-3 border border-red-800/20 bg-vault-red/5">
                              ...
                              {rejectingSubId === sub.id ? (
                                ...
                                <div className="space-y-3 pt-3 border-t border-white/5">
                                  ...
                                  <textarea
                                    ...
                                    rows={5}
                                    className="w-full bg-white/5 border border-red-800/30 rounded-xl px-4 py-3 text-sm
                                      focus:outline-none focus:ring-2 focus:ring-vault-red/40 focus:border-vault-red
                                      placeholder:text-zinc-500/50 transition-all resize-none"
                                  />
                                  <div className="flex items-center justify-between">
                                    <span className={`text-xs ${
                                      rejectFeedback.trim().length < 50 ? "text-red-400" : "text-emerald-400"
                                    }`}>
                                ...
                                <div className="space-y-3 pt-3 border-t border-white/5">
                                  ...
                                  <div className="space-y-1.5">
                                    <label className="text-xs text-zinc-500">
                                      Rate this work <span className="text-red-400">*</span>
                                    </label>
                                        ...
                                        <button
                                          ...
                                          className={`w-8 h-8 rounded-lg flex items-center justify-center transition-all ${
                                            star <= approveRating
                                              ...
                                              : "bg-black/30 text-zinc-500 hover:text-amber-400"
                                          }`}
                                        >
                                  ...
                                  <div className="space-y-1.5">
                                    ...
                                    <textarea
                                      ...
                                      rows={2}
                                      className="w-full bg-white/5 border border-vault-green/30 rounded-xl px-4 py-2 text-sm
                                  ...
                                  {approveStep && (
                                    <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-vault-cyan/5 border border-[#ef233c]/20">
                                      <Loader2 className="w-3.5 h-3.5 text-[#ef233c] animate-spin" />
                                      <span className="text-xs text-[#ef233c]">{approveStep}</span>
                                    </div>
                                  )}
                            ...
                            <div className="flex items-center gap-2 pt-3 border-t border-white/5 flex-wrap">
                              ...
                              {payoutTxnHash && (
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="inline-flex items-center gap-1 px-2 py-1 rounded-lg bg-vault-cyan/5 border border-[#ef233c]/20 text-[#ef233c] text-[10px] font-mono hover:bg-[#ef233c]/10 transition-colors"
                                >
              ...
              <div className="border border-white/10 bg-zinc-900/50 backdrop-blur-sm rounded-2xl p-10 text-center">
